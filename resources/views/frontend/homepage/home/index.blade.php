                        ...
                        <div class="account-sidebar">
                            <div class="category-nav">
                                ...
                                @php
                                    ...
                                    $catImage = $cat->image ?? '';
                                @endphp
                                <div class="category-nav-item {{ $key === 0 ? 'active' : '' }}" data-target="cat-{{ $cat->id }}">
                        ...
                        <div class="account-content">
                            <div class="account-filter-bar">
                                ...
                                <div class="filter-search">
                                    <input type="text" placeholder="Nhập mã tài khoản hoặc tên sản phẩm" class="filter-input" id="filter-keyword">
                                    <button class="filter-search-btn" id="btn-filter-search"><i class="fa fa-search"></i></button>
                                </div>
                                <button class="filter-reset-btn" id="btn-filter-reset" title="Reset bộ lọc"><i class="fa fa-refresh"></i></button>
                            </div>
                            ...
                            <div class="tab-container">
                                ...
                                <div class="tab-pane {{ $key === 0 ? 'active' : '' }}" id="cat-{{ $cat->id }}">
                                    ...
                                    @else
                                    <div class="uk-alert uk-alert-warning uk-text-center">Hiện chưa có tài khoản nào trong danh mục này.</div>
                                    @endif
                                </div>
                                @endforeach
                            </div>
