                                ...
                                <div class="product-stock">
                                    <div class="uk-grid uk-grid-medium uk-grid-width-large-1-2 uk-flex uk-flex-middle">
                                        <div class="prd-btn btn-addtocard">
                                            @if ($product->status == 'sold' || $product->is_sold == 1)
                                                ...
                                                @else
                                                    ...
                                                    <div class="btn-sold-out" style="pointer-events:none; opacity:0.7;">
                                                        <span class="title" style="color:#c00; font-weight:bold;">Tài khoản
                                                            đã bán</span>
                                                        <span class="sub-title" style="color:#777;">Sản phẩm này không còn
                                                            khả dụng</span>
                                                    </div>
                                                @endif
                                            ...
                                            @else
                                                {{-- Chưa mua --}}
                                                <a href="#" class="btn-buy-account" data-id="{{ $product->id }}">
                                    ...
                                    <li class="mb10">
                                        <div class="account-item">
                                            ...
                                            <div class="info">
                                                ...
                                                <div class="readmore"><a href="{{ $canonical }}">Kiểm tra thông tin</a>
                                                </div>
